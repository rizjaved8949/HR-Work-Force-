...
from graph.neo4j_repository import Neo4jGraphRepository  # noqa: E402
...
# tenant-scoped reads/writes share the same Neo4j connection. In legacy
# mode we create a repository handle from the existing Neo4j environment.
if step9_runtime.semantic_service is not None:
    step12_repository = step9_runtime.semantic_service.repository
else:
    step12_repository = Neo4jGraphRepository.from_env()
