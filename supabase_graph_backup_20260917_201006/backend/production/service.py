    ...
    def _graph_checks(self, tenant_id: str) -> list[ProductionCheck]:
        if self.repository is None:
            return [ProductionCheck(
                ...
                severity="error",
                message="Graph repository is not configured for readiness checks.",
            )]
        checks: list[ProductionCheck] = []
        try:
            ...
            checks.append(ProductionCheck(
                ...
                severity="pass",
                message=f"{type(self.repository).__name__} connectivity is available.",
            ))
            ...
            checks.append(ProductionCheck(
                code="neo4j_connectivity",
                severity="error",
                message="Graph repository connectivity check failed.",
