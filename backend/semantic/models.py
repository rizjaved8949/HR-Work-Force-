...
class EmployeeContext(BaseModel):
    ...
    business_unit: SemanticRecord | None = None
    organizational_unit: SemanticRecord | None = None
    work_location: SemanticRecord | None = None
    cost_center: SemanticRecord | None = None
    position: SemanticRecord | None = None
    reporting_position: SemanticRecord | None = None
    position_budget: SemanticRecord | None = None
    vacancy: SemanticRecord | None = None
    manager: SemanticRecord | None = None
    position_requirements: list[SemanticRecord] = Field(default_factory=list)
    position_skill_requirements: list[SemanticRecord] = Field(default_factory=list)
