...
export class HRWorkforceClient {
  constructor({ baseUrl = "", getAccessToken = null, getOrganizationId = null } = {}) {
  ...
  organizations() {
    return this.request("/organization-onboarding/api/organizations");
  }

  organizationReadiness(tenantId) {
    return this.request(`/organization-onboarding/api/organizations/${encodeURIComponent(tenantId)}/readiness`);
  }
